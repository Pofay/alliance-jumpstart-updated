...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/", "/login", "/register", "/user/register", "/applicant", "/static/**")
                .permitAll().antMatchers("/", "/login", "/register", "/user/register", "/apply", "/webjars/**")
                .permitAll().antMatchers("/", "/careers", "/application", "/task/editTask").permitAll()
                .antMatchers("/submitresume", "/careers/applyNow", "/apply", "/updatejob", "/task/saveTask",
                        "/static/**", "/webjars/**")
                .permitAll()
     ...
     * ; registry.addViewController("/applicant").setViewName(
     * "forward:/application.html"); }
     */
